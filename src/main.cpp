    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          json msgJson;
          //double bias = 1.0;
          //msgJson["steering_angle"] = bias*steer_value + (1.0-bias)*angle*M_PI/180.0;
